                ...
                <div class="form_com">
                    <form name="comment" action="{{ route('comments.news') }}" method="post">
                        ...
                        <fieldset>
                            ...
                            <textarea id="editor" name="text" cols="80" rows="10" placeholder="Ваше мнение ..."
                                ></textarea>

                            <input type="hidden" name="news_id" value="{{ $news->id }}" />
                        </fieldset><br>
                        <div style="text-align: center"><botton type="submit" value="Отправить" class="blue_btn" ><i class="fa fa-save"> Сохранить</i>
                        </botton></div><br>
                    </form>
                </div>
            @else
