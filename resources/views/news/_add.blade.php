...
@section('main')
    <div class="new_post">
        ...
        <form method="POST" action="{{ route('add_news') }}" enctype="multipart/form-data">
            ...
            <div class="verh">
                ...
                <div class="fp">Тема<br>
                    ...
                    foreach ($categories as $category) : ?>
                        ...
                        <option value="<?php echo $category->id; ?>" label="<?php echo $category->category_name; ?>"></option>
                        <?php endforeach; ?>
                    </select><br>
                </div>

                <!-- Вставка загрузки файла -->
                {{-- <div class="fp">Картинка новости<br>
                    <div class="input-file-row">
                        <input type="file" name="csv" class="filepond" multiple accept="image/*"
                            data-max-file-size="1MB">
                        <button type="submit"><span>Выберите файл</span></button>

                    </div>
                </div> --}}
                <div class="fp">Картинка новости<br>
                    <input type="file" name="filename" multiple accept="image/*">
                </div>
            ...
            <div class="redactor">
                <textarea id="editor" name="text" rows="20" cols="100"
                    placeholder="Введите текст новости, возможно использование html тегов"></textarea><br>
            </div>
            <script>
                ClassicEditor
