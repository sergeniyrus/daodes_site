...
.img_vote img {
  ...
  height: auto;
  border: 3px solid transparent; /* Начальный цвет рамки */
  transition: border-color 0.3s;
}

.img_vote input[type="radio"]:checked + img {
  border-color: #f00; /* Цвет рамки для выбранного элемента */
}
...
@media only screen and (max-width: 768px) {
  ...
  .good, .item, .admin_menu, .main-blog, .flex-container, .footer, .login, .regwin, .mini-win {
    width: 95%;
  }
  .windows {
    max-width: 80%;
