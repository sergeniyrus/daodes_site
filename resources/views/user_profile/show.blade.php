            ...
            <div class="card-body">
                ...
                <div class="category-block">
                    ...
                    <p class="card-text">
                        ...
                        @if ($profile->nickname)
                            <a href="https://t.me/{{ $profile->nickname }}" target="_blank" style="color:aqua">
                                {{ $profile->nickname }}
                            </a>
                            @if ($profile->telegram_chat_id)
                                <span style="color: #4caf50; margin-left: 8px;">✅
                                    {{ __('user_profile.telegram_linked') }}</span>
                            @endif
                        @else
                ...
                <div class="category-block">
                    ...
                    <p class="card-text"><label>Задачи выполнены:</label> {{ $profile->tasks_completed ?? 'Не указано' }}
                    </p>
