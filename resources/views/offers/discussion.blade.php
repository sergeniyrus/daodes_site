                ...
                <fieldset class="tbr">
                    ...
                    <div class="vote_ratio">
                        ...
                        <label for="choice2" class="img_vote">
                            <input type="radio" id="choice2" class="choice2" name="vote" value="0" class="ratio_r">
...
?><fieldset class="tbr">
              ...
              <table class="tbrv">
                  ...
                  <tr>
                      <td>
                          <div class="graf">
                              <div style="width:{{ $za_percentage }}%; background-color: red; height: 14px;"><span>&nbsp;</span></div>
                          </div>
                      </td>
                  ...
                  <tr>
                      <td>
                          <div class="graf">
                              <div style="width:{{ $no_percentage }}%; background-color: green; height: 14px;"><span>&nbsp;</span></div>
                          </div>
                      </td>
